...
url_template <- paste0(
  'https://eda.seas.gwu.edu/2021-Spring/templates/reflection',
  params$number, '.zip')
```
...
If you haven't yet, go to the [Course Software](https://madd.seas.gwu.edu/2021-Fall/ref-course-software.html) page and install all the software we'll need for this course. You'll need these tools for this assignment.
...
1. **Getting Familiar with the Course**: Follow [Snoop's advice](https://twitter.com/ryancbriggs/status/1293543531496308736?s=20) and read the entire [Course Syllabus](syllabus.html) (actually read the whole thing). Then review the [schedule](schedule.html) and make sure to note important upcoming deadlines.

...
This semester is going to be weird. Please help us all stay safe so we can continue having in-person classes. Yes, the university does require that masks be worn in class, and I hope everyone understands why that policy is in place. Let's work together on this folks. If you're sick, stay home and send me a message, we'll work it out.
...
<i class="fas fa-university"></i> Science & Engineering Hall, Office 2830 | <i class="fa fa-map-marker-alt"></i> [SEH 7040](https://acadtech.gwu.edu/location?staging&id=350&selected=SEH&method=building)
<i class="fas fa-phone"></i> +1 (202) 994-7173 | <i class="far fa-calendar-alt"></i> Sep. 1 - Dec. 8, 2021
<i class="fas fa-envelope"></i> [jpg@gwu.edu](mailto:jph@gwu.edu) | <i class="far fa-clock"></i> 6:10PM - 08:40PM EST
<i class="fab fa-twitter"></i> [\@JohnHelveston](https://twitter.com/JohnHelveston) | <i class="fab fa-slack"></i> [Slack](https://emse-madd-f21.slack.com/)
</div>
...
- We'll be using [Slack](https://emse-madd-f21.slack.com/) for most communication.
...
There will be 5 quizzes given about once every two weeks immediately at the beginning of class. Quizzes cover material presented in previous classes and assignments during the weeks since the most-recent quiz. Quizzes are **short** (~5 minutes) and are designed to identify areas where additional study is needed. **Quizzes are low-stakes** - your worst one is dropped, and the rest count for just 15% of your final grade. If you do poorly on one, use that as feedback on where you need additional improvement.

...
Each week, students will be assigned specific readings to prepare for the next class period. Students will need to submit reflections on these readings each week, which may involve answering some practice questions. 
...
Throughout the semester, students will work in teams of 3-4 students towards a final project. The project is broken into multiple phases with key deliverables due throughout the semester. See the [Project Overview](p0-overview.html) page for more details.

...
Who do you plan on surveying? What is the ideal population you would like to take your survey, and do you have a distribution network in mind to field your survey? By default, we will pay users on Amazon Mechanical Turk (i.e. people from the general U.S. population) to take your survey, but if a specific subpopulation is
required (e.g. people currently shopping for a car), list that here. If you have any other opportunities to distribute your survey to the target population (e.g. an external collaborator, personal networks, etc.), list those here.
...
- **Eligibility questions**: Write out your eligibility requirements. Are you looking for a specific audience, or can anyone take your survey? Be specific. Write the exact question language you plan to use in your survey (e.g. "Are you a car owner?") to identify the target sample. You may need to ask more than one question.

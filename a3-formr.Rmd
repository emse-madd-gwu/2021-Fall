...
1. Make a copy of the survey Google Sheet in your team gmail account.
...
3. Once you have your survey uploaded, you can make it live by creating a "Run". Add your survey to the run by clicking on the `r fa("pen-square")` icon, then add a stopping point by clicking the `r fa("stop")` icon. 
...
- Open up the resulting `reflection3.html` file in your web browser and see how it looks!

...
3. You'll need to install some R packages in RStudio that we will use throughout the semester. To do so, open RStudio then copy-paste [this file](https://raw.githubusercontent.com/emse-madd-gwu/2021-Fall/master/content/packages.R) into the console and press Return. This will install all the packages listed in the file.
